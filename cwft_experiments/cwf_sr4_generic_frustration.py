...
def main():
    ...
    verdict = (
        ...
        "(one expected fixed point); our ensembles with in-degree K >= 2 sit at or above it, the "
        "sparsest (K = 1) below it (0.235) -- "
    ...
    R["SR4_generic_frustration"] = dict(
        ...
        note=("Random self-referential Boolean systems (Kauffman ensemble). Definite "
              ...
              "random-map limit P(frustrated)=1/e~0.368; K >= 2 ensembles at or above it, K = 1 below at 0.235). "
